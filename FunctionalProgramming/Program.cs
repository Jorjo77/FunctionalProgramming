...
namespace FunctionalProgramming
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Predicate всъшност е анонимна функция.Може да се каже че е частен случай на Func защото приема ne]o (promenliwa) и връща bool
            //Работи с Overload
            ...
            //Препоръчани LINQ които е време да започнем да използваме!!!:
            // * First/ FirstOrDefault - връща първия елемент от зададено условие и ако не намери го гърми/връща дефолтната стойност на типа. 
            // * Last/ LastOrDefault - - връща последния елемент от зададено условие и ако не фо намери гърми/връща дефолтната стойност на типа. 
